...
This [document](DOCS/App-damaged.md) expands on the information about the security warning in files downloaded from the Internet, and ways to fix it: Security and Privacy, `xattr` command line tool and **Xattr Editor**.
...
| Drop file window | 
|:----|
| ![Drop window](Images/Window1.png) |
...
| Attributes window | 
|:----|
| ![Attributes window](Images/Window2.png) |
...
| Attribute removal | 
|:----|
| ![Attribute removal](Images/Removal.png) |